...
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-bottom fixed-top navbar-light bg-dark p-2">
        ...
        <div class="collapse navbar-collapse d-flex flex-row-reverse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="btn btn-danger" href="#"><i class="fa-solid fa-right-from-bracket"></i> Log Out</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link active btn btn-primary" href="tabelobat.php"><i class="fa-solid fa-capsules"></i> Obat</a>
            </li>
            <li class="nav-item">
        ...
        <div class="table-responsive">
            ...
            <table class="table table-striped" id="mytable">
                ...
                <tbody>
                    <?php
                    $no = 1;
                    $query = "SELECT obat.*, gudang.nama_gudang FROM obat INNER JOIN gudang ON obat.id_gudang = gudang.id_gudang";
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $val['nama_gudang']; ?></td>
                            <td>
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal2<?php echo $val['id_obat'] ?>">
                                    <i class="fa-solid fa-pen-to-square"></i></button>
                                <!-- <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="">
                                    <i class="fa-solid fa-trash"></i></button> -->
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $val['id_obat'] ?>">
